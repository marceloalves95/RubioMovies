package br.com.rubiomovies.api
...
interface MovieApi {
    ...
    @GET("/3/movie/popular")
    suspend fun getMoviePopular(@Query("language") language:String = PORTUGUESE_BRAZIL, @Query("api_key") apiKey: String = MOVIE_API_KEY):Response<Pages>
